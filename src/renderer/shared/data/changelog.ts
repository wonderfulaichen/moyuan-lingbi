...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      { type: 'improvement', text: '本地模型支持：集成 node-llama-cpp 推理引擎' },
      { type: 'fix', text: '系统粗查角色性格描述误判修复、剧情线检测修复' },
      { type: 'fix', text: '每日字数统计修复：只统计净新增字数' },
      { type: 'fix', text: '编辑器时间标签布局修复、标题重复显示修复' },
      { type: 'fix', text: '细纲按卷拆分文件名匹配修复' },
      { type: 'fix', text: 'AI生成中止功能：模块级 abortController 确保能真正停止AI任务' },
      { type: 'fix', text: '移动端设置页面无法打开、主题切换无效' },
      { type: 'fix', text: '启动白屏问题：Vite base 路径相对化' },
    ],
  },
  {
    version: '0.3.6',
